...
const dataDisplay = document.getElementById("teste");
let novaTarefaArray = []
...
const getlocalstorage = () => {
    if(localStorage.getItem('tarefas')) {
        novaTarefaArray = JSON.parse(localStorage.getItem('tarefas'));
        adicionarTarefa();
...
const adicionarTarefa = () => {
    ...
    localStorage.setItem('tarefas', JSON.stringify(novaTarefaArray));
